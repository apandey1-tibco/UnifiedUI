...
Locator: locator('//mat-row//mat-cell[normalize-space()="BS_AllTypes"]/following-sibling::mat-cell[3]')
Expected pattern: /Deployed/
Received: <element(s) not found>
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for locator('//mat-row//mat-cell[normalize-space()="BS_AllTypes"]/following-sibling::mat-cell[3]')

    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\04_BuisnessServices.spec.ts:40:20
```
