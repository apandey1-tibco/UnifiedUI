...
- Name: Cases e2e suite >> To verify document upload for Doc format
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:375:7
...
Call log:
  - waiting for locator('twc-navmenu-item[label=\'Documents\']')
    ...
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:377:18
```
