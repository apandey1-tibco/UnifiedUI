...
- Name: Work Item e2e suite >> Submit Work Item
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:185:7
...
Call log:
  - waiting for locator('twc-table-row').first() to be visible
    108 × locator resolved to hidden <twc-table-row role="row">…</twc-table-row>

    at HomePage.clickMyWork (C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\PageObjects\HomePage.ts:51:54)
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:197:5
```
...
- main:
  ...
  - button "2201":
    - text: "2201"
    - img
  - text: Work list Work views
  - separator "Resize"
  - text: Default work list Attribute display names
  - switch
  - text: Auto-repeat
  - switch
  - img "Filter":
  ...
  - img "Columns":
    - img
  - table:
    - row "Name Version Description State Id Priority Start date End date Actions":
      - columnheader:
        - checkbox
      - columnheader "Name"
  ...
  - text: No work items available for selected view
- iframe
```
