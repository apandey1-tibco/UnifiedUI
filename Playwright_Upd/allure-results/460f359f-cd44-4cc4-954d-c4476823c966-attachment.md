...
- Name: Pre requisite LDAP - to test Case Manager  >> Add resources to the 2203_Automation LDAP container
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\06_UnifiedUICaseManagerReg4x.spec.ts:506:7
...
Call log:
  - waiting for getByRole('option', { name: '2203_Automation' })
    ...
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\06_UnifiedUICaseManagerReg4x.spec.ts:510:5
```
