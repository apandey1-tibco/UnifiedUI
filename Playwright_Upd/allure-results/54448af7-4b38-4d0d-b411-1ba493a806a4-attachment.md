...
Call log:
  ...
  - waiting for locator('//mat-row//mat-cell[normalize-space()="BS_AllTypes"]/following-sibling::mat-cell[3]')
    2 × locator resolved to <mat-cell role="cell" _ngcontent-ng-c2513059460="" class="mat-mdc-cell mdc-data-table__cell cdk-cell cdk-column-status mat-column-status">…</mat-cell>
      - unexpected value " Undeploying "
...
- main:
  ...
  - button "Local server":
    - text: Local server
    - img
  - dialog "Business Services": Business Services BS_AllTypes BS_simple
  - separator "Resize"
- iframe
```
