...
more_vert"
    ...
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\04_BuisnessServices.spec.ts:113:5
```
...
- table:
  - row "Name Version ID Status Deployed Application Type Action":
    ...
    - columnheader "Action"
  - row "BS_AllTypes 1.0.0.20241118064524597 73 Undeploying a few seconds ago process":
    - cell "BS_AllTypes"
    ...
    - cell:
      - button
  - row "wrm-12070 1.0.0.20260212101938987 69 Deployed a day ago process":
    - cell "wrm-12070"
    - cell "1.0.0.20260212101938987"
    - cell "69"
    - cell "Deployed"
    - cell "a day ago"
    - cell "process"
    - cell:
      - button
  - row "ScriptLogTest 1.1.0.20260504111337295 1 Deployed 6 days ago process":
    - cell "ScriptLogTest"
    - cell "1.1.0.20260504111337295"
    - cell "1"
    - cell "Deployed"
    - cell "6 days ago"
    - cell "process"
