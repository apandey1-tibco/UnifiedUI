...
- Name: Data Admin e2e suite >> Navigation to Data Admin screen for 4x Server
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:472:7
...
Locator: locator('.mat-mdc-select-min-line').filter({ hasText: 'qasw2203' })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('.mat-mdc-select-min-line').filter({ hasText: 'qasw2203' })

    at ApplicationPage.verifyDataAdminPage (C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\PageObjects\ApplicationPage.ts:64:34)
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:493:5
```
