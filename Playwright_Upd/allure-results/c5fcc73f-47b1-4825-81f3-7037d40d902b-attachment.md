...
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\04_BuisnessServices.spec.ts:34:7
...
Call log:
  - navigating to "http://gasdbpmqas02.dev.tibco.com/apps/admin/#/homepage", waiting until "load"

    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\04_BuisnessServices.spec.ts:35:16
```
...
```ts
   ...
   7 | import { BSPage } from "../../PageObjects/BSPage";
   8 |
