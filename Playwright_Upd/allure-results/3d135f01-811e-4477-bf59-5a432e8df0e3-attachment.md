...
- Name: Pre requisite LDAP - to test Case Manager  >> Create the new LDAP container for Server 2203_Automation
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\06_UnifiedUICaseManagerReg4x.spec.ts:428:7
...
Call log:
  - waiting for getByRole('option', { name: '2203_Automation' })
    ...
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\06_UnifiedUICaseManagerReg4x.spec.ts:436:5
```
