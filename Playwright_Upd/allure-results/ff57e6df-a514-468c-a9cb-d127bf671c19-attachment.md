...
- Name: Cases e2e suite >> Update the Case Action and Verify the Updated Value
- Location: C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:271:7
...
Call log:
  - waiting for locator('twc-button[title="Update Case ActionProject-NotAvailableForOther State"]')

    at CaseManagerPage.clickOnUpdateCaseActionBtn (C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\PageObjects\CaseManagerPage.ts:330:36)
    at C:\Old_VDI_Backup\Old_VDI_Downloads_Backup\Playwright_Upd\Playwright_Upd\tests\Parallel\05_UnifiedUIe2e4x.spec.ts:273:18
```
