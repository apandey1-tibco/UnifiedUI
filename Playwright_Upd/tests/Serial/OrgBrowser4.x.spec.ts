...
test.describe.serial('DynamicOrg UI RegressionSuite', () => {
    ...
    //Add 19l02 server in settings
    test('Add 19l02 server in settings', async () => {
        //await page.goto(TestData.gasdbWorkManagerUrl);
        ...
        await expect(unifiedViewsPage.unifiedViewsHeader).toBeVisible();
        ...
        await expect(unifiedViewsPage.registerNewSystemButton).toBeVisible();

        //Fill the Register your system form and submit
        await unifiedViewsPage.enterSystemName("19l02");
